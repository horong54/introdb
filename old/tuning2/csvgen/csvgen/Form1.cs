...
namespace csvgen
{
    public partial class Form1 : Form
    {
        ...
        {
            Random r = new Random();
            StreamWriter sw1 = new StreamWriter((string)data +"1", false);
            StreamWriter sw2 = new StreamWriter((string)data + "2", false);
            ...
            int step = len / 100;
            int count = 0;
            int tid = 0; //for trade id
            sw1.WriteLine("id name last money choo num");
            sw2.WriteLine("tid goods seller price buyer");
            foreach (string str in id)
                for (int i = 0; i < n; i++)
                {
                    ...
                    string uid = str + i;
                    sw1.WriteLine(string.Format("{0},{1},{2:yyyy-MM-dd HH:mm:ss},{3},\\N,{4}",
                        uid, //id
                        name,//name
                        d, //visit
                    ...
                    for (int zz = 0; zz < sell; zz++)
                    {
                        sw2.WriteLine(string.Format("{0},{1},{2},{3},\\N",
                            ++tid, //tid
                            name+"제품",
                            uid, //seller
                            r.Next(50) * 1000 
